...
import DisplayFavoriteParks from "./pages/FavoriteParks/DisplayFavoriteParks";
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path = "/favoriteparks" element={<DisplayFavoriteParks  favoriteParks = {favoriteParks}/>} />
      </Routes>
      <Footer />
    </div>
  );
